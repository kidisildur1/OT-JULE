const seamlessTubeCommonBlocks = [
  {
    ...
    lead: "К работе допускаются только подготовленные сотрудники.",
    badge: { label: "Обязательно", tone: "safe" },
    visualType: "steps",
    cards: [
      { tone: "required", icon: "user", title: "Допуск", text: "инструктаж и понимание задания" },
      { tone: "info", icon: "certificate", title: "Инструктаж", text: "требования изучены до работы" },
      { tone: "warning", icon: "alert", title: "Самочувствие", text: "недомогание = стоп" },
      { tone: "required", icon: "check", title: "Только порученное", text: "без самовольных действий" }
    ],
    miniQuestion: {
      question: "Что нужно сделать, если непонятно, как выполнять работу?",
      options: [
        "начать аккуратно и разобраться по ходу",
        "обратиться к начальнику участка или непосредственному руководителю",
        "попросить коллегу включить оборудование",
        "пропустить этот этап"
      ],
      answer: 1,
      feedback: "Непонятная ситуация останавливает работу до уточнения у руководителя."
    }
  },
  {
    ...
    lead: "Без необходимых СИЗ к работе не приступают.",
    badge: { label: "СИЗ", tone: "safe" },
    visualType: "ppe",
    cards: [
      { tone: "safe", icon: "suit", title: "Спецодежда", text: "исправная и застегнутая" },
      { tone: "safe", icon: "shoe", title: "Спецобувь", text: "устойчивая и исправная" },
      { tone: "safe", icon: "eye", title: "Очки / щиток", text: "защита глаз и лица" },
      { tone: "info", icon: "shield", title: "Перчатки", text: "только где это безопасно" }
    ],
    miniQuestion: {
      question: "Можно ли приступать к работе без необходимых СИЗ?",
      options: ["да, если операция короткая", "нет", "да, если рядом руководитель", "да, если оборудование остановлено"],
      answer: 1,
      feedback: "Без положенных и исправных СИЗ работа не начинается."
    }
  },
  {
    ...
    lead: "Рабочая зона должна быть чистой, свободной и безопасной.",
    badge: { label: "Проверить", tone: "info" },
    visualType: "compare",
    cards: [
      { tone: "danger", icon: "stop", title: "Нельзя", text: "посторонние предметы у оборудования" },
      { tone: "safe", icon: "clean", title: "Правильно", text: "проходы и эвакуация свободны" },
      { tone: "required", icon: "shield", title: "Готовность", text: "аптечка и огнетушитель доступны" },
      { tone: "info", icon: "eye", title: "Освещение", text: "рабочая зона хорошо видна" }
    ],
    miniQuestion: {
      question: "Почему нельзя оставлять посторонние предметы возле оборудования?",
      options: [
        "они мешают безопасной работе и могут попасть в рабочую зону",
        "так удобнее считать инструменты",
        "это влияет только на внешний вид",
        "можно, если предметы небольшие"
      ],
      answer: 0,
      feedback: "Лишние предметы создают риск спотыкания, попадания в механизм и ошибочных действий."
    }
  },
  {
    ...
    lead: "Неисправное оборудование означает запрет работы.",
    badge: { label: "До пуска", tone: "warning" },
    visualType: "steps",
    cards: [
      { tone: "required", icon: "wrench", title: "Инструмент", text: "без трещин и дефектов" },
      { tone: "required", icon: "clamp", title: "Крепления", text: "узлы и оснастка проверены" },
      { tone: "safe", icon: "shield", title: "Ограждения", text: "кожухи на месте" },
      { tone: "danger", icon: "bolt", title: "Электрика", text: "проводка и заземление целые" }
    ],
    miniQuestion: {
      question: "Что делать при обнаружении неисправности?",
      options: [
        "прекратить работу и сообщить руководителю",
        "работать на малой скорости",
        "закрыть неисправность кожухом",
        "доделать операцию и сообщить позже"
      ],
      answer: 0,
      feedback: "При неисправности работу прекращают до устранения причины и разрешения руководителя."
    }
  },
  {
    ...
    lead: "Работы на оборудовании выполняются при нахождении в помещении не менее двух сотрудников.",
    badge: { label: "Роли", tone: "info" },
    visualType: "roles",
    cards: [
      { tone: "required", icon: "user", title: "Оператор", text: "выполняет операцию и держит контроль" },
      { tone: "safe", icon: "eye", title: "Помощник", text: "наблюдает из безопасной зоны" },
      { tone: "info", icon: "center", title: "Пульт", text: "точка управления безопасностью" },
      { tone: "danger", icon: "stop", title: "Посторонние", text: "к рабочей зоне не допускаются" }
    ],
    miniQuestion: {
      question: "Можно ли выполнять работы на оборудовании одному?",
      options: ["да, если есть опыт", "нет", "да, если операция знакомая", "да, если включить видеозапись"],
      answer: 1,
      feedback: "На оборудовании отдела работают минимум вдвоем: оператор и контролирующий сотрудник."
    }
  },
  {
    ...
    lead: "Электрооборудование требует отдельного контроля.",
    badge: { label: "Высокий риск", tone: "danger" },
    visualType: "hazard-map-simple",
    cards: [
      { tone: "danger", icon: "bolt", title: "Провода", text: "не касаться оголенных частей" },
      { tone: "required", icon: "check", title: "До пуска", text: "рубильники, кнопки, заземление" },
      { tone: "danger", icon: "stop", title: "Ремонт", text: "только допущенные лица" },
      { tone: "warning", icon: "alert", title: "Без вещей", text: "не класть одежду на выключатели" }
    ],
    miniQuestion: {
      question: "Можно ли самостоятельно ремонтировать электрооборудование?",
      options: ["нет, только допущенные лица", "да, если отключить питание", "да, если поломка мелкая", "да, после смены"],
      answer: 0,
      feedback: "Ремонт электрооборудования выполняют только сотрудники с соответствующим допуском."
    }
  },
  {
    ...
    lead: "При угрозе жизни, травме, пожаре или неисправности нужно прекратить работу и сообщить.",
    ...
    cards: [
      ...
      { tone: "info", icon: "user", title: "Руководитель", text: "сообщить немедленно" },
      { tone: "warning", icon: "fire", title: "103 / 112", text: "помощь и экстренные службы" }
    ],
    miniQuestion: {
      question: "Какой номер вызвать при травме или угрозе жизни?",
      options: ["101 или 102", "103 или 112", "только внутренний номер", "номер не нужен"],
      answer: 1,
      feedback: "При травме или угрозе жизни вызывают 103 или 112, при пожаре 101 или 112."
    }
  }
];
